...
Label(root,font=("arial",12),text="hours",bg="#000",fg="#fff").place(x=105,y=200)
Label(root,font=("arial",12),text="min",bg="#000",fg="#fff").place(x=225,y=200)
Label(root,font=("arial",12),text="sec",bg="#000",fg="#fff").place(x=345,y=200)
...
def Timer():
   ...
   while times >-1:
    ...
    time.sleep(1)	
    if times==0 :
       playsound=("phone-off-hook-1.wav")
       sec.set("00")
       mins.set("00")
       hrs.set("00")

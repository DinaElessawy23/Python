...
fields=["lists","price","stock"]
grocery_dict2 =[   
{"lists"     : "banana","price": 33,"stock" : 3},
{"lists"     :  "apple","price" :  85,"stock" :5},
{"lists"     :  "orange","price": 99,"stock" :9},
{"lists"     :  "tomato","price" : 25, "stock" :10 }]

file_name="dic.csv"
with open(file_name,'w',newline = '' ) as csvfile:
   writer=csv.DictWriter(csvfile,fieldnames=fields)
   writer.writeheader()
   for rows in grocery_dict2:
